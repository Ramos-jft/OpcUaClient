...
{
    private const string NoSecurityMode = "None";
    ...
    public async Task<Session> ConnectAsync(ApplicationConfiguration configuration)
    {
        ...
        EndpointDescription selectedEndpoint =
            await SelectEndpointAsync(configuration);

        var configuredEndpoint = new ConfiguredEndpoint(
            collection: null!,
            description: selectedEndpoint,
            configuration: EndpointConfiguration.Create(configuration));
        ...
        ApplicationConfiguration configuration)
    {
        _logger.LogInformation(
            "Selecting endpoint: {EndpointUrl}",
